...
input int SlowEmaPeriod = 36;
input int RsiPeriod = 14;
input int AdxPeriod = 14;
input int AtrPeriod = 14;
input double LongRsiMinimum = 54.0;
input double ShortRsiMaximum = 46.0;
...
bool OpenPosition(bool buy_signal, double atr_value, datetime current_bar)
{
   ...
   bool placed = buy_signal
      ? trade.Buy(volume, _Symbol, 0.0, stop, target, "GOLD demo momentum")
      : trade.Sell(volume, _Symbol, 0.0, stop, target, "GOLD demo momentum");
